namespace ShomreiTorah.Billing.Migrator.Forms {
	partial class ImportForm {
		...
		private void InitializeComponent() {
			...
			this.matchingPersonEdit = new ShomreiTorah.WinForms.Controls.Lookup.RepositoryItemItemSelector();
			this.nullPersonEdit = new ShomreiTorah.WinForms.Controls.Lookup.RepositoryItemItemSelector();
			...
			toolTipItem1.Text = "Click to mark this imported person as not matching anyone in the directory.\r\n\r\nA " +
    "new person will be created when the import is finished.";
			superToolTip1.Items.Add(toolTipTitleItem1);
			superToolTip1.Items.Add(toolTipItem1);
			this.matchingPersonEdit.Buttons.AddRange(new DevExpress.XtraEditors.Controls.EditorButton[] {
			...
			toolTipTitleItem2.Text = "Load Data From";
			toolTipItem2.LeftIndent = 6;
			toolTipItem2.Text = "Use this menu to read data from an external file into the import staging area.\r\n\r" +
    "\nNo actual people or payments will be created until finalize the import.";
			...
			toolTipTitleItem3.Text = "Clear Import";
			toolTipItem3.LeftIndent = 6;
			toolTipItem3.Text = "Empties the staging area so that you can start again from scratch.\r\n\r\nDestroys al" +
    "l items in this grid, but does not affect any actual people or payments.";
			...
			toolTipTitleItem4.Text = "Show Duplicates";
			toolTipItem4.LeftIndent = 6;
			toolTipItem4.Text = "Groups the grid to find multiple people who will be imported to the same person f" +
    ...
    "s or duplicates in the source data.";
			...
			toolTipTitleItem5.Text = "Review non-matching people";
			...
			toolTipTitleItem6.Text = "Show bad matches ony";
			toolTipItem6.LeftIndent = 6;
			toolTipItem6.Text = "Filters the grid to only show people who don\'t match their selected row from the " +
    "master directory.\r\n\r\nThese people are more likely to have incorrect matches, and" +
    " should be reviewed carefully.";
			toolTipTitleItem7.LeftIndent = 6;
			toolTipTitleItem7.Text = "\r\nThe grid will remain filtered until you turn this off.";
			...
			toolTipTitleItem8.Text = "Finish Import";
			toolTipItem7.LeftIndent = 6;
			toolTipItem7.Text = "Imports all of these staged rows into actual payments, finishing the import and c" +
    "learing the staging area.";
			toolTipTitleItem9.LeftIndent = 6;
			toolTipTitleItem9.Text = "This action cannot easily be undone.";
			...
			toolTipTitleItem10.Text = "Create Pledges";
			toolTipItem8.LeftIndent = 6;
			toolTipItem8.Text = "Creates pledges for all existing people to bring their balance due to zero.\r\n\r\nUs" +
    "e this after finshing the import to create pledges corresponding to the imported" +
    " payments.";
			toolTipTitleItem11.LeftIndent = 6;
			toolTipTitleItem11.Text = "This will affect all people with payments, regardless of import.";
		...
		private WinForms.Controls.Lookup.RepositoryItemItemSelector nullPersonEdit;
		private WinForms.Controls.Lookup.RepositoryItemItemSelector matchingPersonEdit;
	}
}