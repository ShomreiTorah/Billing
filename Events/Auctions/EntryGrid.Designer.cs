namespace ShomreiTorah.Billing.Events.Auctions {
	partial class EntryGrid {
		...
		private void InitializeComponent() {
			...
			this.amountEdit = new DevExpress.XtraEditors.Repository.RepositoryItemSpinEdit();
			...
			this.colBidAmount.ColumnEditor = this.amountEdit;
            ...
            new DevExpress.XtraEditors.Controls.EditorButton(DevExpress.XtraEditors.Controls.ButtonPredefines.Glyph, "מ", -1, true, true, true, DevExpress.XtraEditors.ImageLocation.MiddleCenter, null, new DevExpress.Utils.KeyShortcut((System.Windows.Forms.Keys.Control | System.Windows.Forms.Keys.M)), serializableAppearanceObject1, "", null, superToolTip1, true)});
			this.amountEdit.DisplayFormat.FormatString = "c";
			this.amountEdit.DisplayFormat.FormatType = DevExpress.Utils.FormatType.Numeric;
			this.amountEdit.EditFormat.FormatString = "c";
			this.amountEdit.EditFormat.FormatType = DevExpress.Utils.FormatType.Numeric;
			this.amountEdit.Mask.EditMask = "c";
			this.amountEdit.Name = "amountEdit";
			this.amountEdit.NullText = "(None)";
			...
			this.smartGridColumn1.Width = 20;
			// 
			// colMBAmount
			// 
		...
		private DevExpress.XtraEditors.Repository.RepositoryItemSpinEdit amountEdit;
