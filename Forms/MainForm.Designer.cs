namespace ShomreiTorah.Billing.Forms {
	partial class MainForm {
		...
		private void InitializeComponent() {
			...
			this.saveXmlDb = new DevExpress.XtraBars.BarButtonItem();
			this.openDirectoryManager = new DevExpress.XtraBars.BarButtonItem();
			this.ribbonPage1 = new DevExpress.XtraBars.Ribbon.RibbonPage();
			this.ribbonPageGroup1 = new DevExpress.XtraBars.Ribbon.RibbonPageGroup();
			this.ribbonPageGroup2 = new DevExpress.XtraBars.Ribbon.RibbonPageGroup();
			this.ribbonPageGroup3 = new DevExpress.XtraBars.Ribbon.RibbonPageGroup();
			this.ribbonPage3 = new DevExpress.XtraBars.Ribbon.RibbonPage();
			this.emailGroup = new DevExpress.XtraBars.Ribbon.RibbonPageGroup();
            ...
            this.ribbonPage4,
            this.ribbonPage2});
			this.ribbon.QuickToolbarItemLinks.Add(this.saveDb);
			this.ribbon.QuickToolbarItemLinks.Add(this.refreshData);
			...
			this.saveDb.Id = 2;
			this.saveDb.ImageOptions.Image = ((System.Drawing.Image)(resources.GetObject("saveDb.ImageOptions.Image")));
			...
			this.showCalendar.ImageOptions.Image = ((System.Drawing.Image)(resources.GetObject("showCalendar.ImageOptions.Image")));
			...
			this.importYK.Id = 7;
			this.importYK.ImageOptions.LargeImage = ((System.Drawing.Image)(resources.GetObject("importYK.ImageOptions.LargeImage")));
			...
			this.refreshData.ImageOptions.Image = ((System.Drawing.Image)(resources.GetObject("refreshData.ImageOptions.Image")));
			...
			this.checkUpdate.ImageOptions.Image = ((System.Drawing.Image)(resources.GetObject("checkUpdate.ImageOptions.Image")));
			...
			this.importRaffle.ImageOptions.LargeImage = ((System.Drawing.Image)(resources.GetObject("importRaffle.ImageOptions.LargeImage")));
			...
			this.showShalachManos.ImageOptions.LargeImage = ((System.Drawing.Image)(resources.GetObject("showShalachManos.ImageOptions.LargeImage")));
			...
			this.shalachManosExport.ImageOptions.LargeImage = ((System.Drawing.Image)(resources.GetObject("shalachManosExport.ImageOptions.LargeImage")));
			...
			// showSeatingForm
			// 
			this.showSeatingForm.Caption = "Seating";
			this.showSeatingForm.Id = 24;
			this.showSeatingForm.ImageOptions.LargeImage = ((System.Drawing.Image)(resources.GetObject("showSeatingForm.ImageOptions.LargeImage")));
			...
			this.showInvites.ImageOptions.LargeImage = global::ShomreiTorah.Billing.Properties.Resources.Invitations32;
			this.showInvites.Name = "showInvites";
			toolTipTitleItem7.Text = "Melave Malka Invitations";
			toolTipItem7.LeftIndent = 6;
			toolTipItem7.Text = "Shows the invitations for the current Melave Malka.";
			...
			this.showCallList.ImageOptions.LargeImage = global::ShomreiTorah.Billing.Properties.Resources.CallList32;
    ...
    "lave Malka.";
			...
			this.showReminderEmailsForm.ImageOptions.LargeImage = global::ShomreiTorah.Billing.Properties.Resources.EmailList32;
    ...
    "e Malka.";
			...
			// saveXmlDb
			// 
			this.saveXmlDb.Caption = "Dump XML";
			this.saveXmlDb.Id = 31;
			this.saveXmlDb.ImageOptions.LargeImage = global::ShomreiTorah.Billing.Properties.Resources.SaveAs32;
			this.saveXmlDb.Name = "saveXmlDb";
			toolTipTitleItem13.Text = "Dump XML Database";
			toolTipItem13.LeftIndent = 6;
			toolTipItem13.Text = "Saves all loaded data as an XML file.\r\n\r\nUse this button if the normal Save butto" +
    "n does not work, then email the file to Schabse.\r\n\r\nThe XML file is not directly" +
    " useful on its own.";
			superToolTip13.Items.Add(toolTipTitleItem13);
			superToolTip13.Items.Add(toolTipItem13);
			this.saveXmlDb.SuperTip = superToolTip13;
			this.saveXmlDb.ItemClick += new DevExpress.XtraBars.ItemClickEventHandler(this.saveXmlDb_ItemClick);
			// 
			// openDirectoryManager
			// 
			this.openDirectoryManager.Caption = "Directory Manager";
			this.openDirectoryManager.Id = 32;
			this.openDirectoryManager.ImageOptions.LargeImage = global::ShomreiTorah.Billing.Properties.Resources.DirectoryManager32;
			this.openDirectoryManager.Name = "openDirectoryManager";
			this.openDirectoryManager.RibbonStyle = DevExpress.XtraBars.Ribbon.RibbonItemStyles.Large;
			toolTipTitleItem14.Text = "Open Directory Manager";
			toolTipItem14.LeftIndent = 6;
			toolTipItem14.Text = "Opens the Directory Manager, allowing you to merge or delete people.\r\n\r\nThis is a" +
    " separate application.";
			superToolTip14.Items.Add(toolTipTitleItem14);
			superToolTip14.Items.Add(toolTipItem14);
			this.openDirectoryManager.SuperTip = superToolTip14;
			this.openDirectoryManager.ItemClick += new DevExpress.XtraBars.ItemClickEventHandler(this.openDirectoryManager_ItemClick);
			// 
			// ribbonPage1
			// 
			...
			this.ribbonPageGroup3.ItemLinks.Add(this.addRelativeLink, true);
			...
			// emailGroup
			// 
			this.emailGroup.AllowTextClipping = false;
			...
			// wordGroup
			// 
			this.wordGroup.AllowTextClipping = false;
			...
			// ribbonPageGroup6
			// 
			this.ribbonPageGroup6.ItemLinks.Add(this.showSeatingForm);
			this.ribbonPageGroup6.Name = "ribbonPageGroup6";
			this.ribbonPageGroup6.ShowCaptionButton = false;
			this.ribbonPageGroup6.Text = "ימים נוראים";
			// 
			// ribbonPage2
			// 
			...
			this.addPledgePanel.FloatSize = new System.Drawing.Size(668, 406);
			...
			this.addPledgePanel.Size = new System.Drawing.Size(668, 406);
			...
			this.addPaymentPanel.FloatSize = new System.Drawing.Size(673, 406);
		...
		private DevExpress.XtraBars.Ribbon.RibbonPageGroup wordGroup;
